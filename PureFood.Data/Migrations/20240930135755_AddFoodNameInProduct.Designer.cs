...
namespace PureFood.Data.Migrations
{
    ...
    [Migration("20240930135755_AddFoodNameInProduct")]
    partial class AddFoodNameInProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PureFood.Core.Domain.Content.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryName = "rau-cu",
                            CreatedAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(1796),
                            Description = "Rau củ quả ngon lành",
                            UpdateAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(1988)
                        },
                        new
                        {
                            CategoryId = new Guid("6b5f6458-3791-4303-8ee7-e20707e4cf3e"),
                            CategoryName = "trai-cay",
                            CreatedAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(1991),
                            Description = "Trái cây tươi mới",
                            UpdateAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(1992)
                        });
                });
            ...
            modelBuilder.Entity("PureFood.Core.Domain.Content.Supplier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(2092),
                            ...
                            UpdatedAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(2092)
                        },
                        new
                        {
                            SupplierId = new Guid("9b8bc0ba-e6af-4445-8509-390f404c1ea6"),
                            Address = "FPT Quận 9, Thành phố Hồ Chí Minh",
                            CreatedAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(2100),
                            ...
                            PhoneNumber = "0937056922",
                            SuplierName = "Moncati",
                            UpdatedAt = new DateTime(2024, 9, 30, 20, 57, 55, 38, DateTimeKind.Local).AddTicks(2101)
                        });
                });
